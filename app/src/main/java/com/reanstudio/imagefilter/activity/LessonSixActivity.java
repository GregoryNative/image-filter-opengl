...
import com.reanstudio.imagefilter.renderer.LessonSixRenderer;
import com.reanstudio.imagefilter.surface.LessonSixGLSurfaceView;
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            case MIN_DIALOG: {
                ...
                builder.setItems(getResources().getStringArray(R.array.lesson_six_min_filter_types),
