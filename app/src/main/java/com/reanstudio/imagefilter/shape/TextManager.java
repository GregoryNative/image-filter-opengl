...
public class TextManager {
    ...
    public void draw(float[] m) {
        ...
        GLES20.glUseProgram(ReinierGraphicTools.SP_TEXT);
        ...
        int mPositionHandle = GLES20.glGetAttribLocation(ReinierGraphicTools.SP_TEXT,
                "vPosition");
        ...
        int mTexCoordLoc = GLES20.glGetAttribLocation(ReinierGraphicTools.SP_TEXT,
                "a_texCoord" );
        ...
        int mColorHandle = GLES20.glGetAttribLocation(ReinierGraphicTools.SP_TEXT,
                "a_Color");
        ...
        int mtrxhandle = GLES20.glGetUniformLocation(ReinierGraphicTools.SP_TEXT,
                "uMVPMatrix");

        // Apply the projection and view transformation
        GLES20.glUniformMatrix4fv(mtrxhandle, 1, false, m, 0);

        int mSamplerLoc = GLES20.glGetUniformLocation (ReinierGraphicTools.SP_TEXT,
                "s_texture" );
